...
class TelethonPool:
    ...
    async def premium_enter_card(self, client: TelegramClient, invoice_msg,
        ...
        if verify_url:
            # MUHIM: URL olingach, brauzerni DARHOL ochish o'rniga,
            # BIROZ KUTAMIZ — bu Telegram/bank (Checkout.com) serveri
            # tomonida sessiyaning TO'LIQ tayyor bo'lishi (provisioning)
            # uchun vaqt beradi. SendPaymentFormRequest javob qaytarsa
            # ham, bank tomonidagi sessiya hali "yozilib ulgurmagan"
            # bo'lishi mumkin — bu holatda darrov ochilgan brauzer
            # noto'liq/tayyor bo'lmagan sessiyaga tushishi mumkin edi.
            print("[NATIVE] Bank sessiyasi tayyorlanishi uchun 15s kutilmoqda...")
