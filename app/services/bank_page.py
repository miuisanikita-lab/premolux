...
async def submit_otp_generic(url: str, otp: str, timeout_ms: int = 25000) -> bool:
    """
    Umumiy usul — har qanday 3-D Secure sahifasida sinab ko'riladi.
    Muvaffaqiyat/muvaffaqiyatsizlikni qaytaradi.

    DIQQAT: bu funksiya Telegram invoice'dan OLINGAN url bilan chaqiriladi
    — bu url ni qanday olish (Telethon to'lov oqimidan) telethon_pool.py
    da premium_flow_start/premium_enter_card ichida hal qilinadi.
    """
