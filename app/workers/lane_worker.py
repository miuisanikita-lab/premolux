...
async def _step_buy_premium(db: AsyncSession, lane: Lane, pool: TelethonPool) -> None:
    ...
    # ── MUHIM: AVVAL sahifa ochiladi — bu bankni OTP yuborishga
    # undaydi. Faqat SHUNDAN KEYIN OTP kutiladi (forwarder orqali).
    # Avval OTP kutib, keyin sahifa ochish — TESKARI va ishlamaydi,
    # chunki bank hech qachon SMS yubormaydi (sahifa ochilmagan). ──
    try:
