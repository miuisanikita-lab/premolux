...
async def _step_buy_premium(db: AsyncSession, lane: Lane, pool: TelethonPool) -> None:
    ...
    # ── MUHIM: AVVAL sahifa ochiladi VA KARTA MA'LUMOTI KIRITILADI
    # (SmartGlocal "tokenize" sahifasi buni talab qiladi) — bu bankni
    # OTP yuborishga undaydi. Faqat SHUNDAN KEYIN OTP kutiladi. ──
    try:
